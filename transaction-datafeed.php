...
$apikey = "iH5Vjc2Zm1QWvETxFmi4UNrF4TsW2MEakzZyFWsSM8J8GxvcNIaDms9lbrc3";
...
if (isset($_POST["FoxyData"])) {
    ...
    foreach($xml->transactions->transaction as $transaction) {
        ...
        if (!$is_multiship) {
            ...
            $subtotal = (string)$transaction->shipto_subtotal;
			$tax_total = (string)$transaction->tax_total;
			$shipping_total = (string)$transaction->shipping_total;
			$order_total = (string)$transaction->order_total;
		}
        ...
        foreach($transaction->transaction_details->transaction_detail as $transaction_detail) {
            ...
            foreach($transaction_detail->transaction_detail_options->transaction_detail_option as $transaction_detail_option) {
                ...
                if ($product_option_name == 'profit') {
                    $profit_total += $product_option_value;
                }
            }
        ...
        $file = $_SERVER['DOCUMENT_ROOT'] . '/total.txt';
